...
def initialize_gui():
    ...
    query_entry = Entry(input_frame, width=60, borderwidth=2, fg="black", font=('Consolas', 14))
    ...
    response_entry = Entry(input_frame, width=60, borderwidth=2, fg="black", font=('Consolas', 14))
    ...
    query_listbox = tk.Listbox(root, width=80, height=12, font=('Consolas', 14))
    ...
    add_button = tk.Button(button_frame, text="Add Query", width=25, height=2, command=add_query)
    add_button.pack(side="left", padx=5)

    update_button = tk.Button(button_frame, text="Update Query", width=25, height=2, command=update_query)
    update_button.pack(side="left", padx=5)

    delete_button = tk.Button(button_frame, text="Delete Query", width=25, height=2, command=delete_query)
    delete_button.pack(side="left", padx=5)

    save_button = tk.Button(button_frame, text="Save Queries", width=25, height=2, command=save_queries)
    save_button.pack(side="left", padx=5)

    change_json_button = tk.Button(button_frame, text="Change JSON File", width=25, height=2, command=change_json_file)
