...
with open(r"..\SAB (AI Assistant)\json_files\eng_intents.json") as file:
    data = json.load(file)

try:
    with open("..\\SAB (AI Assistant)\\bot\\eng\\data.pickle", "rb") as f:
    ...
    for x, doc in enumerate(docs_x):
        ...
        with open("..\\SAB (AI Assistant)\\bot\\eng\\data.pickle", "wb") as f:
...
try:
    model.load("..\\SAB (AI Assistant)\\bot\\eng\\model.tflearn")
except:
    model = tflearn.DNN(net) #####
    model.fit(training, output, n_epoch=1000, batch_size=8, show_metric=True)
    model.save("..\\SAB (AI Assistant)\\bot\\eng\\model.tflearn")
